title "Song Exercise"
description "An exercise to practice using classes and objects in JavaScript."
...
function printedSong() {
    ...
    console.log ("I got money, money, money, money runnin' through my chromosomes (yeah), /n");
}
